                ...
                return (
                    <SiteLi as="li">
                        ...
                        <a
                            ...
                            title={`visit the ${wfSite2Data.projectName} and development live site to view on Github gh-pages`}
                            target="_new"
                        ...
                        <a
                            ...
                            title={`visit the ${wfSite2Data.projectName} and development repository to view on Github`}
                            target="_new"
                            rel="noopener noreferrer"
                        >
