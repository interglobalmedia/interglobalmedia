                ...
                return (
                    <SiteLi as="li">
                        ...
                        <a
                            ...
                            title={`visit the React ${wfSite1Data.projectName} live site to view on Github gh-pages`}
                            target="_new"
                        ...
                        <a
                            ...
                            title={`visit the React ${wfSite1Data.projectName} repository to view on Github`}
                            target="_new"
                            rel="noopener noreferrer"
                        >
